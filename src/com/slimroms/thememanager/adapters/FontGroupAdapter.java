    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.clickContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton(mContext.getString(R.string.select), new
                ...
                ThemedTypefaceHelper typefaceHelper = typefaceCache.getHelperForFont(mContext,
                        overlay);
                ...
                final TextView txtCyrillicBold = (TextView) preview.findViewById(R.id
                        .preview_italic_bold);
                txtCyrillicBold.setTypeface(typefaceHelper.getTypeface(Typeface.BOLD_ITALIC),
                        Typeface.BOLD);
