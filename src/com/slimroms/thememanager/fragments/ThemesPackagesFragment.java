...
public class ThemesPackagesFragment extends Fragment implements LoaderManager
        .LoaderCallbacks<List<Theme>>,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new ThemesPackagesAdapter(getContext(), new ThemesPackagesAdapter
                .ThemeClickListener() {
            @Override
